...
/// <summary>
/// TWGCB-04-014-0051: AES 128/128
/// </summary>
public class Aes128Cipher : SecurityCheckBase
{
    public override string SupportedRuleId => "TWGCB-04-014-0051";
    ...
    protected override AuditResult ExecuteCheck(ServerManager serverManager, TwgcbRule rule)
    {
        ...
        try
        {
            var registryPath = @"SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Ciphers\AES 128/128";
            ...
            using (var key = Registry.LocalMachine.OpenSubKey(registryPath))
            {
                if (key == null)
                {
                    ...
                    result.Details = "AES 128/128 預設為啟用";
                }
                else
                {
