...
/// <summary>
/// TWGCB-04-014-0044: SSLv3
/// </summary>
public class SslV3Protocol : SecurityCheckBase
{
    public override string SupportedRuleId => "TWGCB-04-014-0044";
    ...
    protected override AuditResult ExecuteCheck(ServerManager serverManager, TwgcbRule rule)
    {
        ...
        try
        {
            var registryPath = @"SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\SSL 3.0\Server";
