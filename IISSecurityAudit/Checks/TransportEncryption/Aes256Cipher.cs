...
/// <summary>
/// TWGCB-04-014-0052: AES 256/256
/// </summary>
public class Aes256Cipher : SecurityCheckBase
{
    public override string SupportedRuleId => "TWGCB-04-014-0052";
    ...
    protected override AuditResult ExecuteCheck(ServerManager serverManager, TwgcbRule rule)
    {
        ...
        try
        {
            var registryPath = @"SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Ciphers\AES 256/256";
            ...
            using (var key = Registry.LocalMachine.OpenSubKey(registryPath))
            {
                if (key == null)
                {
                    ...
                    result.Details = "AES 256/256 預設為啟用";
                }
                else
                {
