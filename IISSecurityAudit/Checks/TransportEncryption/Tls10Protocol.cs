...
/// <summary>
/// TWGCB-04-014-0045: TLS 1.0
/// </summary>
public class Tls10Protocol : SecurityCheckBase
{
    public override string SupportedRuleId => "TWGCB-04-014-0045";
    ...
    protected override AuditResult ExecuteCheck(ServerManager serverManager, TwgcbRule rule)
    {
        ...
        try
        {
            var registryPath = @"SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.0\Server";
